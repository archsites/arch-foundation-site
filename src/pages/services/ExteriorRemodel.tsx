  ...
  <Layout>
    <section className="relative min-h-[60vh] flex items-center">
      <div className="absolute inset-0">
        <img src={photos.exteriorStoneFront} alt="Exterior remodel with stone facade" className="w-full h-full object-cover" />
      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="space-y-6">
            <img src={photos.sidingCrewInstall} alt="Siding installation in progress" className="rounded-lg shadow-xl w-full" />
            <img src={photos.exteriorStoneWallBuild} alt="Stone facade construction" className="rounded-lg shadow-xl w-full" />
          </div>
        </div>
      </div>
    </section>
