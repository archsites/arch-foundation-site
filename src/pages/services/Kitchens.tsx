  ...
  <Layout>
    <section className="relative min-h-[60vh] flex items-center">
      <div className="absolute inset-0">
        <img src={photos.kitchenModernIsland} alt="Modern kitchen renovation by Arch GC" className="w-full h-full object-cover"  loading="eager" decoding="async" fetchPriority="high" />
